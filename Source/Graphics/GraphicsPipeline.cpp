...
namespace cvr
{
	GraphicsPipeline::GraphicsPipeline(Device* device, Swapchain* swapchain,  DescriptorManager* descriptors, RenderPass* renderPass)
		:m_Device{ device }, m_Swapchain{swapchain},  m_Descriptors {descriptors}, m_RenderPass{ renderPass }
	{
	...
	void GraphicsPipeline::createGraphicsPipeline()
	{
		...
		pipelineLayoutInfo.pSetLayouts = &m_Descriptors->getDescriptorSetLayout();
