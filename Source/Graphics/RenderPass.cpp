...
namespace cvr
{
	RenderPass::RenderPass(Swapchain* swapchain, Device* device)
	...
	void RenderPass::createRenderPass()
	{
		...
		depthAttachment.format = findDepthFormat(); //TODO: MAKE SURE THAT WE DONT DUPLICATE THIS FUNCTION BUT FOR NOW ITS EASIER WHILE REFORMATTING
